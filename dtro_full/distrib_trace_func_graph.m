...
%          across iterations
% W_star : (Optional) True projection matrix, computed for example with the
...
% norm_track      : Sequence of ||W^(i+1)-W^(i)||_F^2
% norm_star_track : Sequence of ||W^(i)-W^*||_F^2
%
% EXTERNAL FUNCTIONS
% dijkstra.m : Can be replaced by other algorithms pruning the graph to a
%              tree.
